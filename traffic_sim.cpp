...
float get_y_val(float x1, float y1,
                float x2, float y2,
                float x){
   return ((((y2-y1)/(1.0*(x2-x1)))*(x-x1)) + y1);
}
...
float Link::get_output_capacity()
{
    ...
    if( x<=0.04 ){
        return  bmax*get_y_val(0,0,0.04,0.04*70,x);
    } else if( x <= 0.05 ){
        return  bmax*get_y_val(0.04,0.04*70,0.05,0.05*60,x);
    } else if( x <= 0.10 ){
        return  bmax*get_y_val(0.05,0.05*60,0.1,0.1*40,x);
    } else if( x <= 0.14 ){
        return  bmax*get_y_val(0.1,0.1*40,0.14,0.14*30,x);
    } else if( x <= 0.25 ){
        return  bmax*get_y_val(0.14,0.14*30,0.25,0.25*20,x);
    } else if( x <= 0.33 ){
        return  bmax*get_y_val(0.25,0.25*20,0.33,0.33*15,x);
    } else if( x <= 0.35 ){
        return  bmax*get_y_val(0.33,0.33*15,0.35,0.35*12.5,x);
    } else if( x <= 0.60 ){
        return  bmax*get_y_val(0.35,0.35*12.5,0.6,0.6*6,x);
    } else if(x <= 0.75){
        return  bmax*get_y_val(0.6,0.6*6,0.75,0.75*3,x);
    }
