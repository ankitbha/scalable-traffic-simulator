...
SH_numbers = [1,2,3,4]
total_cycle = 240
act_stage_lengths = [total_cycle/len(SH_numbers) for i in range(len(SH_numbers))]
calc_stage_lengths = [total_cycle/len(SH_numbers) for i in range(len(SH_numbers))]
...
while Vissim.Simulation.AttValue('SimSec') < Sim_end:
    # Cycle level
