...
filename = r"C:\Users\zj2187\Desktop\10.3\Double_sig.inpx" #好像不能用相对路径
Vissim.LoadNet(filename)
Filename = r"C:\Users\zj2187\Desktop\10.3\Double_sig.layx"
...
SH_numbers = [1,2]
total_cycle = 120
stage_lengths = [total_cycle/2 for i in range(len(SH_numbers))]
