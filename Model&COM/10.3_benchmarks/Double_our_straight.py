...
filename = r"C:\Users\zj2187\Desktop\10.3\Double_no_straight.inp0"
Vissim.LoadNet(filename)
Filename = r"C:\Users\zj2187\Desktop\10.3\Double_no_straight.layx"
...
for i in range(0,30000):
    ...
    if(num_sdc==0): # if no cars come yet, we let it continous run
        ...
        for cur_Veh in All_Vehicles: # we only control the car in link 1-4 and let the output link 5 keep 120km/h
            ...
            if(len(lane)==3):
                idx = int(lane[0])-1
            if((idx == 0) and (veh_Type=='100')):
                cur_Veh.SetAttValue('DesSpeed', speed[0])
            else:
