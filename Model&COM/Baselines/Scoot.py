...
filename = r"C:\Users\zj2187\Desktop\Baseline\Scats.inpx" #好像不能用相对路径
Vissim.LoadNet(filename)
Filename = r"C:\Users\zj2187\Desktop\Baseline\Scats.layx"
...
SH_numbers = [1,2,3,4]
total_cycle = 120
act_stage_lengths = [total_cycle/4 for i in range(len(SH_numbers))]
calc_stage_lengths = [total_cycle/4 for i in range(len(SH_numbers))]
...
Sim_end = 1500 # simulation second [s]
