...
filename = r"C:\Users\ra3106\Desktop\MtoNj\NjtoM_Equal.inpx" #好像不能用相对路径
Vissim.LoadNet(filename)
Filename = r"C:\Users\ra3106\Desktop\MtoNj\NjtoM_Equal.layx"
...
t2 = threading.Thread(target=intersection, args=[[4,5], 2, Vissim])
t3 = threading.Thread(target=intersection, args=[[6,7], 3, Vissim])
t1.run()
t2.run()
t3.run()
